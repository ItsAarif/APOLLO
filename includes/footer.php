        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Group B26 </h2>
              <p>Arif Chaudhary (BE_COMP_73)
Harsh Singh (BE_COMP_72)
Hrutuja Saswade (BE_COMP_71)</p>
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#Algorithms" class="py-2 d-block">Algorithms</a></li>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text"> A-Block, Thakur Educational Campus, 
Shyamnarayan Thakur Marg, 
Thakur Village, Kandivali East, 
Mumbai, Maharashtra 400101. </span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 9987452353</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">apollosystem2020@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All Rights Reserved | Group B26</a>
  </p>
          </div>
        </div>
      </div>
